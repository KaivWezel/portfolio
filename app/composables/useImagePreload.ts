 ...
 */
export function useImagePreload(imageRefs: any): {
  ...
  const setupImageLoading = () => {
    ...
    const validImages = images
      ...
      .filter((img: any) => img !== null && img !== undefined && img instanceof HTMLImageElement);
    ...
    validImages.forEach((img: HTMLImageElement) => {
